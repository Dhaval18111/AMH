...
namespace AMH.Services.V1
{
    public class ProductServices : AbstractProductServices
    {
        ...
        public override SuccessResult<AbstractProduct> Product_ById(int Product_Id)
        {
            return this.abstractProductDao.Product_ById(Product_Id);
        }
        public override PagedList<AbstractProduct> Product_All(PageParam pageParam, string search,int IsVisibleAll)
        {
            return this.abstractProductDao.Product_All(pageParam, search, IsVisibleAll);
        }
