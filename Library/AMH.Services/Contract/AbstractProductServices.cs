...
namespace AMH.Services.Contract
{
    public abstract class AbstractProductServices
    {
        ...
        public abstract SuccessResult<AbstractProduct> Product_ById(int Product_Id);
        public abstract PagedList<AbstractProduct> Product_All(PageParam pageParam, string search,int IsVisibleAll);
