...
namespace AMH.Data.Contract
{
...

    {
        ...
        public abstract SuccessResult<AbstractFeedback> Feedback_ActInact(int Feedback_Id, int Updatedby);
        public abstract SuccessResult<AbstractFeedback> Feedback_Delete(int Feedback_Id, int Deletedby);
        public abstract PagedList<AbstractFeedback> Feedback_All(PageParam pageParam, string Search,int IsVisibleAll);
