...
namespace AMH.Data.Contract
{
...

    {
        ...
        public abstract SuccessResult<AbstractWishlist> Wishlist_ActInact(int Wish_Id, int Updatedby);
        public abstract SuccessResult<AbstractWishlist> Wishlist_Delete(int Wish_Id, int Deletedby);
        public abstract PagedList<AbstractWishlist> Wishlist_All(PageParam pageParam, string Search,int IsVisibleAll);
